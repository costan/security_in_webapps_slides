...
* Can be detected by examining your application's implementation in isolation.
...
* Fix: _never_ echo a user's password - HTML, e-mail, SMS
...
* Scales better: don't need to hit the database to check cookies.
